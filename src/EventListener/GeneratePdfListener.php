...
class GeneratePdfListener
{
    ...
    public function __invoke(ResponseEvent $event): void
    {
        ...
        if (!$config = $this->contaoPdfGeneration->getCurrentConfig()) {
            return;
        }
        ...
        try {
            ...
            // Set debug for images
            $pdf->showImageErrors = $this->kernel->isDebug();
            ...
            // Remove the trigger parameter for the generation of the pretty error screen
            $request->request->remove(ContaoPdfGenerationBundle::TRIGGER_PARAM);
